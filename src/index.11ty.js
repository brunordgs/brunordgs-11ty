...
exports.render = function () {
	return /* html */ `
		<section class="container home">
			<div class="homeAbout">
				<div>
					<h1 class="homeAbout__title"><span>Bruno</span> <span>Rodrigues</span></h1>
					<h2 class="homeAbout__subtitle">Software Engineer</h2>
					<p class="homeAbout__miniBio">
						I'm a
						<a href="https://github.com/brunordgs" target="_blank" rel="nofollow noreferrer">
							software engineer</a
						>
						and a lover of new technologies. I help developers build stuff, learn things through communities and building products that make developer's lives easier.
					</p>
				</div>

				<div>
					<div class="home__item">
						<h3 class="home__itemTitle">know <span class="colorHighlight">who I am</span></h3>

						<div class="homeCard">
							<h4 class="homeCard__title">A little more about me</h4>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quia totam earum saepe provident nisi repudiandae veritatis laborum, voluptatum fugit recusandae.</p>
    ...
    1.6 2.3 4.3 3.3 5.6 2.3 1.6-1.3 1.6-3.9 0-6.2-1.4-2.3-4-3.3-5.6-2z"
					/>
									...
									<a href="/about" class="homeCard__seeAllCta">See all about who I am <span class="colorHighlight" aria-hidden="true">→</span></a>
							</div>
						</div>
					</div>

					<div class="home__item">
						<h3 class="home__itemTitle">learn <span class="colorHighlight">stuff</span></h3>
						
						<div class="homeCard">
							<h4 class="homeCard__title">Maybe I can help you</h4>
							<p>Nowadays, I'm working at specific projects and this is how I've been learning so much without wasting time.</p>
							<div class="homeCard__actions">
								<a 
									href="/projects"
									class="homeCard__button">
